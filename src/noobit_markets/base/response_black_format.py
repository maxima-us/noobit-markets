...
__all__ = ["resp_json", "get_req_content"]
...
) -> Result[pydantic.PositiveInt, BaseError]:
...
result_or_err_sig = typing.Callable[
    [httpx.Response],
    typing.Coroutine[typing.Any, typing.Any, Result[typing.Any, typing.Any]],
]


parse_err_content_sig = typing.Callable[
    [typing.Iterable[BaseError], str], typing.Tuple[BaseError]
]
