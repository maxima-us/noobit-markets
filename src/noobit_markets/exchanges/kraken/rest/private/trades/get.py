...
async def get_usertrades_kraken(
    ...
    valid_result_content = validate_base_result_content_usertrades(result_content.value)
    ...
    valid_parsed_result_data = validate_parsed_result_data_usertrades(parsed_result_data)
